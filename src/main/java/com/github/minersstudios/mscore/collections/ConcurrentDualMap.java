...
public final class ConcurrentDualMap<K1, K2, V> {
	private final @NotNull ConcurrentHashMap<K1, V> primaryMap = new ConcurrentHashMap<>();
	private final @NotNull ConcurrentHashMap<K2, K1> secondaryKeyMap = new ConcurrentHashMap<>();
